		...
		<table class="mainbox">
			<tr>
				...
				<td class="login">
					...
					<p>验证码: <input type="text" name="seccode" class="txt seccode" tabindex="2" id="seccode" value="" /><img width="70" height="21" src="<?php echo UC_ADMINSCRIPT;?>?m=seccode&seccodeauth=<?php echo $seccodeinit;?>&<?php echo rand();?>" class="checkcode" /></p>
