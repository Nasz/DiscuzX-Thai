...
หากคุณติดตั้ง UCenter ไว้แล้วกรุณากรอกข้อมูลต่อไปนี้ให้ครบถ้วน หากยังไม่ได้ติดตั้ง กรุณาไปที่ <a href="http://www.discuz.com/" target="blank">ศูนย์ผลิตภัณฑ์ Comsenz</a> ดาวน์โหลดและติดตั้ง ก่อนที่จะดำเนินการขั้นถัดไป',
	...
	'license' => '
<div class="license"><h1>ข้อตกลงใช้งานเวอร์ชั่นภาษาไทยสำหรับผู้ใช้งานชายไทย</h1>
<p>สงวนลิขสิทธิ์ &copy; 2001-' . date('Y') . '，บริษัท เทนเซ็นต์คลาวด์คอมพิวติ้ง (ปักกิ่ง) จำกัด (เดิมชื่อ บริษัท ปักกิ่ง คังเชิง ซินชวง เทคโนโลยี จำกัด) ผู้เป็นเจ้า (ต่อไปนี้เรียกว่า "<strong>เทนเซ็นต์คลาวด์</strong>") </p>

<p>สงวนลิขสิทธิ์ &copy; 2008-' . date('Y') . '，เว็บไซต์ดิสคัซไซนช์ (เดิมคือเว็บไซต์นอร์ทไซนช์) ผู้บรรยายไทย (ต่อไปนี้เรียกว่า "<strong>ผู้แปล</strong>")</p>
