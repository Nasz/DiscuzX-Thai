...
หากคุณติดตั้ง UCenter ไว้แล้วกรุณากรอกข้อมูลต่อไปนี้ให้ครบถ้วน หากยังไม่ได้ติดตั้ง กรุณาไปที่ <a href="http://www.discuz.com/" target="blank">ศูนย์ผลิตภัณฑ์ Comsenz</a> ดาวน์โหลดและติดตั้ง ก่อนที่จะดำเนินการขั้นถัดไป',
	...
	'license' => '
<div class="license"><h1>ข้อตกลงใช้งานเวอร์ชั่นภาษาไทยสำหรับผู้ใช้งานชาวไทย</h1>
<p>สงวนลิขสิทธิ์ &copy; 2001-' . date('Y') . '，บริษัท เทนเซ็นต์คลาวด์คอมพิวติ้ง (ปักกิ่ง) จำกัด (เดิมชื่อ บริษัท คังเชิงครีเอทีฟเทคโนโลยี (ปักกิ่ง) จำกัด) ผู้เป็นเจ้าของ (ต่อไปนี้เรียกว่า "<strong>เทนเซ็นต์คลาวด์</strong>") </p>
...
<p>ผลิตภัณฑ์เทนเซ็นต์คลาวด์ Discuz! X มีศูนย์รวมส่วนเสริมและแอปพลิเคชั่นอย่างเป็นทางการดำเนินการโดย บริษัท เหอเฟย์เน็ตเวิร์คเทคโนโลยี (อาดาว) จำกัด โครงการโอเพ่นซอร์สดูแลและดำเนินการโดย บริษัท เหอเฟย์เน็ตเวิร์คเทคโนโลยี (อาดาว) จำกัด โอเพ่นซอร์สโค้ดของ Discuz! X ได้รับการดูแลร่วมกันโดย คณะกรรมการบริหารโครงการโอเพ่นซอร์สและชุมชนนักพัฒนา นอกจากบริการข้างต้นแล้วบริการทั้งหมดจัดหามาให้โดยเทนเซ็นต์คลาวด์</p>
