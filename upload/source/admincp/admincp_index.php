...
function show_forever_thanks() {
	$copyRightMessage = array(
		'สงวนลิขสิทธิ์',
		'บริษัท เทนเซ็นต์คลาวด์คอมพิวติ้ง (ปักกิ่ง) จำกัด',
		'ดำเนินการโดย',
		'บริษัท เหอเฟย์เน็ตเวิร์คเทคโนโลยี จำกัด',
	);
	$gitTeamStr = '';
	$gitTeam = array(
		'laozhoubuluo' => 'เหลาจูปูหลัว',
		'popcorner' => 'popcorner',
		'oldhuhu' => 'oldhuhu',
		'zoewho' => 'หูจุงเฉิน',
		'3dming' => 'จูเก๋อเสี่ยวหมิง',
		'brotherand2' => 'brotherand2',
		'contributions' => 'git',
		'nftstudio' => 'หนีเฟิงเทียน',
		'ONEXIN' => 'ONEXIN',
	);
