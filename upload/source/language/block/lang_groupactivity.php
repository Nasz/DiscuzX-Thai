...
(
	...
	'groupactivity_keyword' => '标题คีย์เวิร์ด',
	'groupactivity_keyword_comment' => '设置标题包含的คีย์เวิร์ด。注意: 留空为不进行任何过滤； คีย์เวิร์ด中可使用通配符 *； 匹配多个คีย์เวิร์ด全部，可用空格或 AND 连接。如 win32 AND unix； 匹配多个คีย์เวิร์ด其中部分，可用 | 或 OR 连接。如 win32 OR unix',
	...
	'groupactivity_recommend' => 'แนะนำ主题过滤',
