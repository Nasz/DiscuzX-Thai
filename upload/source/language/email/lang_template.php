...
(
	...
	'email_verify_click_link' => 'เพียงคลิกที่ลิงก์ด้านล่างเพื่อเปิดใช้งานบัญชีของคุณ：',
	...
	'add_member_info' => 'ข้อมูลเกี่ยวกับบัญชี',
	'add_member_bbname' => '网站名称：',
	'add_member_siteurl' => '网站地址：',
	'add_member_newusername' => '用户名：',
	'add_member_newpassword' => '密码：',
	'add_member_can_login' => 'จากนี้ไป คุณสามารถใช้บัญชีของคุณเพื่อเข้าสู่ระบบ {$var[\bbname\]} ได้เลย ขอให้มีความสุขในการใช้งานเว็บบอร์ดของเรา!',
...
或错误的填写了生日信息。本邮件不会多次重复发送，',
	...
	'moderate_member_explain3' => 'ถูกลบ：เนื่องจากการลงทะเบียนของคุณแตกต่างไปจากข้อกำหนดของเราเป็นอย่างมาก หรือจำนวนการลงทะเบียนใหม่บนเว็บไซต์นี้เกินความคาดหมาย ใบสมัครของคุณจึงถูกปฏิเสธ บัญชีของคุณได้ถูกลบออกจากฐานข้อมูลแล้ว คุณจะไม่สามารถใช้มันเพื่อเข้าสู่ระบบหรือยื่นอุธรเพื่อขอให้ตรวจสอบอีกครั้งได้ โปรดเข้าใจ',
