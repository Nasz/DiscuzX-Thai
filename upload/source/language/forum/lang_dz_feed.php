...
(
	...
	'feed_post_magic_title' =>		'{operater} แต่งพร๊อพ {magiccard} ให้กับโพสต์ {thread} ของ {actor}',

	'feed_user_profile_title' =>		'{actor} อัปเดตข้อมูลส่วนตัว',

	'feed_user_usergroup_title' =>		'{actor} อัปเกรดกลุ่มเป็น {usergroup}',

	'feed_user_credit_title' =>		'{actor} มีจำนวนเครดิตถึง {count}',

	'feed_user_threads_title' =>		'{actor} มีจำนวนกระทู้ถึง {count}',
