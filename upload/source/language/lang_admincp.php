...
(
	...
	'tips_textarea' => 'กล่องอินพุตสองเท่าเพื่อขยาย/แคบ',
	'name' => 'ชื่อ',
	'none' => 'ไม่มี',
	'default' => 'ค่าเริ่มต้น',
	...
	'login_nosecques' => 'คุณยังไม่ได้ลงชื่อเข้าใช้ด้วยความปลอดภัยโปรดไปที่ศูนย์การจัดการหลังจากตั้งคำถามความปลอดภัยในศูนย์ส่วนตัวของคุณคุณสามารถ <a href="home.php?mod=spacecp&ac=profile&op=password" target="_blank">คลิกที่นี่</a> ป้อนการตั้งค่าคำถามความปลอดภัย',
	...
	'home_security_nofounder' => '<li>คุณยังไม่ได้ตั้งค่า <u>ผู้ก่อตั้งไซต์</u>ผู้ใช้ทั้งหมดในกลุ่มผู้ใช้ผู้ดูแลระบบสามารถเข้าสู่ศูนย์การจัดการกรุณาแก้ไข config/config_global.php เพิ่มผู้ก่อตั้งผู้ก่อตั้งเพื่อควบคุมอำนาจของสมาชิกของทีมอย่างมีประสิทธิภาพ',
	...
	'home_upload_perm' => 'อัพโหลดใบอนุญาต',
	...
	'setting_access_access_adminipaccess' => 'อนุญาตให้เข้าถึงศูนย์การจัดการ IP รายการ',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'admingroup_edit_admincpperm' => 'สิทธิ์ศูนย์การจัดการ',
	...
	'usergroups_edit_post_custom_bbcode_comment' => 'ตั้งค่าว่าจะวิเคราะห์ศุลกากรในโพสต์ของผู้ใช้ โค๊ต Discuz! ข้อสังเกต: ปรับแต่ง Discuz! รหัสถูกกำหนดโดยสมาชิกในทีมผู้บริหารในศูนย์การจัดการไม่รวมรหัสหลายสิบรหัสที่สร้างขึ้นในระบบ',
	...
	'usergroups_edit_attach_post_comment' => 'การตั้งค่าว่าจะอัปโหลดไปยังฟอรัมโดยไม่ได้รับอนุญาตพิเศษความต้องการ PHP การตั้งค่าอนุญาตให้ใช้งานได้โปรดดูหน้าแรกของศูนย์การจัดการ',
	'usergroups_edit_image_post' => '允许上传图片',
	'usergroups_edit_image_post_comment' => 'การตั้งค่าว่าจะอัปโหลดรูปภาพไปยังฟอรัมโดยไม่ได้รับอนุญาตพิเศษความต้องการ PHP การตั้งค่าอนุญาตให้ใช้งานได้โปรดดูหน้าแรกของศูนย์การจัดการ',
	...
	'usergroups_edit_attach_max_size_comment' => 'ตั้งค่าขนาดสูงสุดของไฟล์แนบ(หน่วย K 1M=1024K)，0 สำหรับไม่มีข้อ จำกัด จำเป็นต้อง PHP การตั้งค่าอนุญาตให้ใช้งานได้โปรดดูหน้าแรกของศูนย์การจัดการ',
	...
	'usergroups_edit_home_image_max_size_comment' => 'ตั้งค่าขนาดสูงสุดของภาพเดียวของอัลบั้ม(หน่วย K 1M=1024K)，0 สำหรับไม่มีข้อ จำกัด จำเป็นต้อง PHP การตั้งค่าอนุญาตให้ใช้งานได้โปรดดูหน้าแรกของศูนย์การจัดการ',
	...
	'plugins_edit_adminid_comment' => 'ใช้พารามิเตอร์ปลั๊กในอินเทอร์เฟซปลั๊กในศูนย์การจัดการเพื่อตั้งค่าข้อกำหนดระดับการอนุญาตขั้นต่ำที่จำเป็นสำหรับโปรแกรม ข้อสังเกต: โมดูลพื้นหลังของปลั๊กในมีการตั้งค่าอำนาจของตัวเองดังนั้นจึงไม่อยู่ภายใต้ข้อ จำกัด นี้',
