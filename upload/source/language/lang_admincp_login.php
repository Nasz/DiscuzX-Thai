...
(
	...
	'login_nosecques' => 'คุณยังไม่ได้ลงชื่อเข้าใช้ด้วยความปลอดภัยโปรดไปที่ศูนย์การจัดการหลังจากตั้งคำถามความปลอดภัยในศูนย์ส่วนตัวของคุณคุณสามารถ <a href="forum.php?mod=memcp&action=profile&typeid=1" target="_blank">คลิกที่นี่</a> ป้อนการตั้งค่าคำถามความปลอดภัย',
	...
	'login_cplock' => 'แผงการจัดการของคุณถูกล็อค!<br>กรุณา<b> {ltime} </b>หลังจากวินาทีให้ไปที่ศูนย์การจัดการ',
