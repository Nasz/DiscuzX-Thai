...
$lang = array (
  ...
  'admingroups_edit_succeed' => 'อัปเดตการตั้งค่าการอนุญาตกลุ่มผู้ดูแลระบบเรียบร้อยแล้ว',
  ...
  'plugins_install_succeed' => 'ติดตั้งแล้ว！<br />เพื่อใช้ปลั๊กนี้ตามปกติ คุณอาจต้องลบหรือแก้ไขไฟล์หรือเทมเพลตที่เกี่ยวข้อง สำหรับรายละเอียดโปรดตรวจสอบคำแนะนำการติดตั้งของปลั๊กอินนี้<br /><br /><a href="https://addon.dismall.com/?view=plugins" target="_top">点击这里返回应用中心</a><br />',
  ...
  'adv_title_more' => '抱歉，您的广告标题超过 50 ตัวอักษร',
  ...
  'smsgw_name_more' => '抱歉，您的短信网关名称超过 255 ตัวอักษร',
  ...
  'cloudaddons_installing' => '应用 {addonid} 安装中，โปรดรอ......',
  ...
  'forums_name_toolong' => '版块名称不能超过50ตัวอักษร',
  ...
  'members_add_username_tooshort' => '抱歉，您输入的用户名小于 3 ตัวอักษร，请输入一个较长的用户名',
  'members_add_username_toolong' => '抱歉，您的用户名超过 15 ตัวอักษร，请输入一个较短的用户名',
  ...
  'members_edit_lock' => '您不能直接锁定该用户，请<a href="{ADMINSCRIPT}?action=members&operation=search&uid={uid}&submit=yes&frames=yes" target="_blank">แก้ไข</a>去掉其“{grouptitle}”身份',
  'members_edit_illegal' => '您不能直接禁止该用户，请<a href="{ADMINSCRIPT}?action=members&operation=search&uid={uid}&submit=yes&frames=yes" target="_blank">แก้ไข</a>去掉其“{grouptitle}”身份',
  ...
  'members_stat_do_stepstat' => '更新统计数据中({i} / {t})，โปรดรอ...',
  'members_stat_bad_fieldid' => '指定的资料项不正确',
  'members_stat_update_option_succeed' => '更新统计项成功 ',
  'members_stat_do_stepstat_prepared' => '准备更新统计数据，共 {t} 项。此过程将自动完成，โปรดรอ...',
  ...
  'members_newsletter_notify_succeed' => 'ประกาศเว็บไซต์发送成功 ',
  ...
  'focus_add_num_limit' => '抱歉，最多只能เพิ่ม 10 条站长推荐',
  ...
  'plugins_conflict' => 'ปลั๊กอินเปิดใช้งานแล้ว</h4><br />友情提示：您刚启用的插件与某些插件存在共用的嵌入点。虽然共用嵌入点属于正常情况，但是如果您遇到插件运行不正常的情况请及时联系插件作者。<a href="javascript:;" onclick="display(\'conflict\')">[คลิกเพื่อดู]</a><br /><div id="conflict" style="display:none"><br />{plugins}<br /></div><br />',
  ...
  'threadsplit_manage_forum_processing' => '已处理完 {table}，โปรดรอ...',
  'threadsplit_manage_forum_complete' => '已更新บอร์ดทั้งหมด存档区',
