...
',
	...
	array (
		...
		array (
			'ปรับเพิ่มประสิทธิภาพ' => 'action=setting&operation=seo',
			'ตั้งค่าแคชของฟอรัม' => 'action=setting&operation=cachethread',
		),
		'text' =>
		array (
			0 => '性能优化 &raquo; 论坛页面缓存设置',
			1 => 'setting_cachethread',
			2 => 'ตั้งค่าแคชของฟอรัม',
	...
	array (
		...
		array (
			'水印设置' => 'action=setting&operation=imgwater',
			'ฟอรั่ม' => 'action=setting&operation=imgwater&anchor=forum',
		),
		'text' =>
		array (
			0 => '水印设置 &raquo; 论坛',
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	array (
		...
		array (
			...
			84 => '允许上传附件',
			85 => 'การตั้งค่าว่าจะอัปโหลดไปยังฟอรัมโดยไม่ได้รับอนุญาตพิเศษความต้องการ PHP การตั้งค่าอนุญาตให้ใช้งานได้โปรดดูหน้าแรกของศูนย์บริหารจัดการ',
			...
			90 => '允许上传图片',
			91 => 'การตั้งค่าว่าจะอัปโหลดรูปภาพไปยังฟอรัมโดยไม่ได้รับอนุญาตพิเศษความต้องการ PHP การตั้งค่าอนุญาตให้ใช้งานได้โปรดดูหน้าแรกของศูนย์บริหารจัดการ',
