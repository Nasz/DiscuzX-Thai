...
$lang = array (
	...
	array (
		'index' =>
		array (
			'ถังรีไซเคิลบล็อก' => 'action=blogrecyclebin',
		),
		'text' =>
		array (
			0 => 'ถังรีไซเคิลบล็อก',
	...
	array (
		...
		array (
			...
			16 => '创建相册用户名',
			17 => 'โปรดคั่นชื่อผู้ใช้หลายรายการด้วยเครื่องหมายจุลภาค ","',
			18 => 'blog_search_friend',
			19 => 'ดูสิทธิ์',
			20 => 'album_search_time',
			21 => 'อัปเดตช่วงเวลา',
			22 => 'รูปแบบ yyyy-mm-dd',
		),
	),
	135 =>
	array (
	...
	array (
		...
		'text' =>
		array (
			0 => 'การจัดการบล็อก &raquo; รายการล่าสุด',
			1 => 'blog_tips',
			2 => 'การจัดการข้อมูลบล็อกแบบแบทช์ใช้เพื่อลบบล็อกออกพร้อมกับการตอบกลับที่เกี่ยวข้อง คำหลักสามารถใช้ตัวระบุได้ {x} หากต้องการจำกัดข้อความที่สามารถละเว้นระหว่างอักขระสองตัวที่อยู่ติดกัน x คือจำนวนอักขระที่ถูกละเว้น เช่น "a{1}s{2}s"(โดยไม่ต้องใส่เครื่องหมายคำพูด) สามารถค้นหา "ass" ได้ด้วย "axsxs" และ "axsxxs" ฯลฯ คำเตือน: การคลิกปุ่มลบบนหน้าผลการค้นหาจะเป็นการลบข้อมูลที่เกี่ยวข้องโดยตรง!',
		),
	),
	139 =>
	array (
		...
		'text' =>
		array (
			0 => 'การจัดการบล็อก &raquo; ค้นหา',
			1 => 'blog_search_detail',
			2 => 'แสดงรายการบล็อกโดยละเอียด',
			3 => 'blog_search_perpage',
			4 => 'จำนวนการแสดงต่อหน้า',
			5 => 'resultsort',
			6 => 'เรียงลำดับผลลัพธ์',
			7 => 'blog_search_uid',
			8 => 'UID ของผู้ใช้',
			9 => 'โปรดแยก UID หลายอันด้วยเครื่องหมายจุลภาค ","',
			10 => 'blog_search_blogid',
			11 => 'ID บล็อก',
			12 => 'โปรดแยก ID บล็อกหลายรายการด้วยเครื่องหมายจุลภาค ","',
			13 => 'blog_search_user',
			14 => 'ชื่อผู้ใช้ที่โพสต์บล็อก',
			15 => 'โปรดแยกชื่อผู้ใช้หลายชื่อด้วยเครื่องหมายจุลภาค ","',
			16 => 'blog_search_keyword',
			17 => 'ชื่อหรือคำหลักของเนื้อหา',
			18 => 'โปรดใช้เครื่องหมายจุลภาค "," เพื่อแยกคำหลักหลายคำ สามารถใช้ตัวระบุ {x}',
			19 => 'blog_search_friend',
			20 => 'ดูสิทธิ์',
			21 => 'blog_search_ip',
			22 => 'IP เผยแพร่',
			23 => 'Wildcard "*" เช่น "127.0.*.*" (ไม่มีเครื่องหมายคำพูด) โปรดใช้ด้วยความระมัดระวัง!!!',
			24 => 'blog_search_lengthlimit',
			25 => 'ความยาวเนื้อหาขั้นต่ำ',
			26 => 'ฟังก์ชั่นนี้จะเพิ่มภาระบนเซิร์ฟเวอร์',
			27 => 'blog_search_view',
			28 => 'จำนวนการดู',
			...
			32 => '热度',
			33 => 'blog_search_time',
			34 => 'ช่วงเวลาการตีพิมพ์',
			35 => 'รูปแบบ yyyy-mm-dd',
		),
	),
	140 =>
	array (
