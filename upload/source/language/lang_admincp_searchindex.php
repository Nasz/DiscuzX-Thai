...
$lang = array (
	...
	array (
		'index' =>
		array (
			'แนะนำ好友' => 'action=specialuser&operation=defaultuser',
		),
		'text' =>
		array (
			0 => 'แนะนำ好友',
	...
	array (
		...
		array (
			0 => '日志管理 &raquo; 最新列表',
			1 => 'blog_tips',
			2 => '批量日志信息管理用于删除日志使用，并且连同对应的回复一同删除。คีย์เวิร์ด可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略字符的个数，如 "a{1}s{2}s"(不含引号) 可以搜索到 "ass" 也可搜索到 "axsxs" 和 "axsxxs" 等等。提醒：点击搜索结果页的删除按钮，将会直接删除相关信息！',
		),
	),
	135 =>
	array (
		...
		array (
			...
			17 => '标题或内容คีย์เวิร์ด',
			18 => '多คีย์เวิร์ด中间请用半角逗号 "," 隔开，关键词可以用限定符 {x}',
	...
	array (
		...
		array (
			0 => 'จัดการสมุดโน๊ต',
			1 => 'doing_tips',
			2 => '批量记录信息管理用于删除记录使用，并且连同对应的回复一同删除。คีย์เวิร์ด可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略字符的个数，如 "a{1}s{2}s"(不含引号) 可以搜索到 "ass" 也可搜索到 "axsxs" 和 "axsxxs" 等等。提醒：点击搜索结果页的删除按钮，将会直接删除相关信息！',
		),
	),
	154 =>
	array (
		...
		array (
			...
			12 => '内容คีย์เวิร์ด',
			13 => '多คีย์เวิร์ด中间请用半角逗号 "," 隔开，关键词可以用限定符 {x}',
...
由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，腾讯云不对因使用此功能造成的任何损失承担责任。财付通服务热线：0755-83762288-2(全天24小时服务热线)',
	...
	array (
		...
		array (
			...
			28 => 'keywords',
			29 => 'keywords用于搜索引擎优化，放在 meta 的 keyword 标签中，多个คีย์เวิร์ด间请用半角逗号 "," 隔开',
	...
	array (
		...
		array (
			...
			44 => 'keywords',
			45 => 'keywords用于搜索引擎优化，放在 meta 的 keyword 标签中，多个คีย์เวิร์ด间请用半角逗号 "," 隔开',
	...
	array (
		...
		array (
			...
			57 => 'แนะนำ主题规则',
			58 => 'แนะนำ主题规则，只对自动和半自动生成推荐主题列表有效，此规则均为降序排列',
			59 => 'forums_edit_extend_recommend_num',
			60 => 'แนะนำ主题显示数量',
			61 => 'แนะนำ主题显示的数量，默认为 10 条，建议不要超过 20 条',
			62 => 'forums_edit_extend_recommend_imagenum',
			63 => 'แนะนำ主题图片附件显示数量',
			64 => 'แนะนำ主题中图片附件显示的数量，默认为 5 条。设置为 0 则不显示，建议不要超过 10 条',
			65 => 'forums_edit_extend_recommend_imagesize',
			66 => 'แนะนำ主题图片附件显示大小',
			67 => 'แนะนำ主题中图片附件显示的大小，默认为 300 x 250',
	...
	array (
		...
		array (
			...
			8 => 'แนะนำ内容',
			9 => '此处支持 HTML 代码，建议少于150ตัวอักษร',
...
',
	...
	array (
		...
		array (
			0 => '论坛批量删帖',
			1 => 'prune_tips',
			2 => '批量删帖仅用于删除违规帖子使用，如您需要批量删除历史旧帖，请使用批量主题管理功能。使用此功能，需同时提供起始时间和终止时间其中之一，及发帖用户名、发帖 IP、内容คีย์เวิร์ด其中之一，至少共二项必要的条件，否则将无法进行操作。如果符合删除条件的帖子为主题第一帖，或该主题无回复，将删除整个主题。如果您不是论坛管理员，您只能删除从某一时间到现在的范围内的帖子。超级版主的删帖的时间范围为二星期(14 天)；版主的时间范围为一星期(7 天)且只能删除所管辖论坛内的帖子。คีย์เวิร์ด可以使用限定符 {x} 以限定相邻两字符间可忽略的文字，x 是忽略字符的个数，如 "a{1}s{2}s"(不含引号) 可以搜索到 "ass" 也可搜索到 "axsxs" 和 "axsxxs" 等等。',
			...
			21 => '内容คีย์เวิร์ด',
			22 => '多คีย์เวิร์ด中间请用半角逗号 "," 隔开，关键词可以用限定符 {x}',
	...
	array (
		...
		array (
			...
			33 => 'หน้าลงทะเบียน:',
			34 => 'ตั้งค่าที่อยู่ mod ในการสมัครสมาชิก ค่าเริ่มต้นคือ "register" การปรับเปลี่ยนชื่อจะช่วยป้องกันซอฟต์แวร์ DDoS การเปลี่ยนแปลงการตั้งค่านี้ไม่เหมือนกับ Discuz! X เวอร์ชันก่อนหน้า เพียงปรับเปลี่ยนที่นี่ไม่จำเป็นต้องแก้ไขชื่อไฟล์ใด ๆ',
	...
	array (
		...
		array (
			...
			10 => '直接/快速跳转的信息',
			11 => '当开启直接/快速跳转以后，以下信息将会直接跳转。每行填写一个信息的คีย์เวิร์ด',
		),
	),
	228 =>
	array (
	...
	array (
		...
		array (
			...
			5 => '缓存论坛首页有效期',
			6 => '设置论坛首页缓存更新的时间，单位为วินาที 0 为关闭(此处关闭以后，缓存系数将不再起作用)，建议设置为 900。此功能只针对游客',
			7 => 'setting_cachethread_life',
			8 => '缓存帖子有效期',
			9 => '设置帖子页面缓存更新的时间，单位为วินาที 0 为关闭。请根据实际情况进行调整，建议设置为 900。另外，请通过编辑论坛来指定帖子页面缓存系数',
...
สามารถล้างโพสต์เก่าโดยผู้เขียนไม่สูญเสียเครดิต 0 หมายถึงไม่ใช้ฟังก์ชันนี้และอัปเดตคะแนนผู้ใช้เสมอ',
			...
			44 => 'กำหนดว่าแผงผู้ดูแลจะแสดงจำนวนหัวข้อ โพสต์ และผู้ใช้ที่ต้องการให้ตรวจสอบโดยละเอียดหรือไม่',
		),
	),
	236 =>
	array (
	...
	array (
		...
		array (
			...
			2 => '邮件发送方式',
			3 => '如需使用 SSL 加密的 SMTP 发送，请在服务器地址前เพิ่ม ssl:// 并调整端口号。',
...
(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	array (
		...
		array (
			...
			76 => '忽略需要审核的คีย์เวิร์ด',
			77 => '选择“是”则此用户组的用户在发表时不会触发需要审核的คีย์เวิร์ด',
