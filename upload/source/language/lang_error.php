...
(
	...
	'suggestion_plugin' => 'หากคุณเป็นเว็บมาสเตอร์ฉันขอแนะนำให้คุณลองปิดที่ศูนย์การจัดการ <a href="admin.php?action=plugins&frames=yes" class="guess" target="_blank">{guess}</a> เสียบเข้าไป <a href="admin.php?action=tools&operation=updatecache&frames=yes" class="guess" target="_blank">รีเฟรชแคช</a> แก่นแท้หากปัญหาได้รับการแก้ไขหลังจากปลั๊กในขอแนะนำให้คุณติดต่อปลั๊กอินปลั๊กเพื่อขอความช่วยเหลือ',
	'suggestion' => 'หากคุณเป็นเว็บมาสเตอร์ขอแนะนำให้คุณลองที่ศูนย์การจัดการ <a href="admin.php?action=tools&operation=updatecache&frames=yes" target="_blank">รีเฟรชแคช</a> คุณยังสามารถผ่าน <a href="https://www.discuz.net/" target="_blank">Discuz! สถานีอย่างเป็นทางการ</a> ขอความช่วยเหลือหากคุณแน่ใจว่านี่เป็นโ Bug คุณสามารถเป็นได้โดยตรง <a href="https://gitee.com/discuz/DiscuzX/issues" target="_blank">ส่ง Issue</a> ให้เรา',
