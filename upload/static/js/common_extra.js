...
function _showColorBox(ctrlid, layer, k, bgcolor) {
	...
	if(!$(ctrlid + '_menu')) {
		...
		var colortexts = ['สีดำ', 'สีเหลืองสด', 'สีเขียวมะกอกเข้ม', 'สีเขียวเข้ม', 'สีน้ำเงิน-เทาเข้ม', 'น้ำเงิน', 'สีคราม', 'สีเขียวเข้ม', 'สีแดงเข้ม' , 'สีส้มเข้ม ', 'สีมะกอก', 'สีเขียว', 'สีเขียวนกเป็ดน้ำ', 'สีหม่น', 'สีเทาศิลา', 'สีเทาเข้ม', 'สีแดง', 'สีน้ำตาลอมเหลือง', 'สีเขียวอมเหลือง', 'สีเขียวน้ำทะเล', 'สีเขียวมรกต', 'สีน้ำเงิน', 'สีม่วง', 'สีเทา', 'สีม่วงแดง', 'สีส้ม', 'สีเหลือง', 'สีเหลืองมะนาว', 'สีฟ้า', 'สีคราม', 'สีม่วงเข้ม', 'สีเงิน', 'สีชมพู', 'สีเหลืองอ่อน', 'สีครีม', 'สีเขียวอ่อน', 'สีเขียวอ่อน', 'สีฟ้าสดใส', 'สีพลัม', 'สีขาว'];
		var str = '';
		for(var i = 0; i < 40; i++) {
