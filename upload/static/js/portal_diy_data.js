...
drag.extend({
	...
	init : function (sampleMode) {
		this.initCommon();
		$('samplepanel').innerHTML = 'สามารถจัดการข้อมูลโมดูลได้โดยตรง [<a href="javascript:;" onclick="spaceDiy.cancel();return false;" class="xi2">ยกเลิก</a>]';
	...
	blockForceUpdate : function (e,all) {
		...
		bcontent.innerHTML = '<center>โหลดเนื้อหา...</center>';
		var x = new Ajax();
