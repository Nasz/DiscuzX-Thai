...
function seditor_menu(seditorkey, tag) {
	...
	if(!$(menuid)) {
		...
		menu.innerHTML = '<span class="y"><a onclick="hideMenu()" class="flbc" href="javascript:;">ปิด</a></span><div class="p_opt cl"><form onsubmit="' + submitstr + ';return false;" autocomplete="off"><div>' + str + '</div><div class="pns mtn"><button type="submit" id="' + ctrlid + '_submit" class="pn pnc"><strong>ส่ง</strong></button><button type="button" onClick="hideMenu()" class="pn"><em>ยกเลิก</em></button></div></form></div>';
	}
