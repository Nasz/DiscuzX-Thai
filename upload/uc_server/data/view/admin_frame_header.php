...
<div class="mainhd">
	...
	<div class="uinfo">
		<p>您好, <em><?php echo $username;?></em> [ <a href="<?php echo UC_ADMINSCRIPT;?>?m=user&a=logout" target="_top">เลิก</a> ]</p>
		<?php if($admincp) { ?>
			<p id="others"><a href="#" class="othersoff" onclick="showmenu(this);">แพลตฟอร์มการจัดการอื่น ๆ</a></p>
