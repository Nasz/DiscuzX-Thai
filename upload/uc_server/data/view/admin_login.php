		...
		<table class="mainbox">
			<tr>
				...
				<td class="login">
					...
					<p id="usernamediv">ชื่อผู้ใช้: <input type="text" name="username" class="txt" tabindex="1" id="username" value="<?php echo $username;?>" /></p>
					<p>รหัสผ่าน: <input type="password" name="password" class="txt" tabindex="2" id="password" value="<?php echo $password;?>" /></p>
					<p>แคปต์ชา: <input type="text" name="seccode" class="txt seccode" tabindex="2" id="seccode" value="" /><img width="70" height="21" src="<?php echo UC_ADMINSCRIPT;?>?m=seccode&seccodeauth=<?php echo $seccodeinit;?>&<?php echo rand();?>" class="checkcode" /></p>
...
<div class="footer">ขับเคลื่อนโดย UCenter <?php echo UC_SERVER_VERSION;?> ลิขสิทธิ์ &copy; 2001-2022 เทนเซ็นต์คลาวด์</div>
