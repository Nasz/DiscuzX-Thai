		...
		<div class="mainbox nomargin">
			<form action="<?php echo UC_ADMINSCRIPT;?>?m=setting&a=ls" method="post">
				...
				<table class="opt">
					...
					<tr>
					<td>
						<input type="radio" id="pmcenteryes" class="radio" name="pmcenter" value="1" <?php echo $pmcenter[1];?> onclick="$('hidden1').style.display=''"  /><label for="pmcenteryes">ใช่</label>
						<input type="radio" id="pmcenterno" class="radio" name="pmcenter" value="0" <?php echo $pmcenter[0];?> onclick="$('hidden1').style.display='none'" /><label for="pmcenterno">ไม่</label>
					</td>
					...
					<tr>
						<td>
							<input type="radio" id="sendpmseccodeyes" class="radio" name="sendpmseccode" value="1" <?php echo $sendpmseccode[1];?> /><label for="sendpmseccodeyes">ใช่</label>
							<input type="radio" id="sendpmseccodeno" class="radio" name="sendpmseccode" value="0" <?php echo $sendpmseccode[0];?> /><label for="sendpmseccodeno">ไม่</label>
						</td>
					...
					<tr>
					<td>
						<input type="radio" id="addappbyurlyes" class="radio" name="addappbyurl" value="1" <?php echo $addappbyurl[1];?>  /><label for="addappbyurlyes">ใช่</label>
						<input type="radio" id="addappbyurlno" class="radio" name="addappbyurl" value="0" <?php echo $addappbyurl[0];?> /><label for="addappbyurlno">ไม่</label>
					</td>
					<td>是否启用通过 URL 添加应用功能，建议只在需要通过 URL 添加应用时开启</td>
					</tr>
					<tr>
						<th colspan="2">启用不安全的删除用户接口:</th>
					</tr>
					<tr>
					<td>
						<input type="radio" id="insecureuserdeleteyes" class="radio" name="insecureuserdelete" value="1" <?php echo $insecureuserdelete[1];?>  /><label for="insecureuserdeleteyes">ใช่</label>
						<input type="radio" id="insecureuserdeleteno" class="radio" name="insecureuserdelete" value="0" <?php echo $insecureuserdelete[0];?> /><label for="insecureuserdeleteno">ไม่</label>
					</td>
					<td>是否启用不安全的删除用户接口，建议只有必须使用此接口且无法改造应用时开启</td>
					</tr>
					<tr>
		...
		<div class="mainbox nomargin">
			<form action="<?php echo UC_ADMINSCRIPT;?>?m=setting&a=register" method="post">
				...
				<table class="opt">
					...
					<tr>
						<td>
							<input type="radio" id="yes" class="radio" name="doublee" value="1" <?php echo $doublee[1];?> /><label for="yes">ใช่</label>
							<input type="radio" id="no" class="radio" name="doublee" value="0" <?php echo $doublee[0];?> /><label for="no">ไม่</label>
						</td>
					</tr>
					<tr>
		...
		<div class="mainbox nomargin">
			<form action="<?php echo UC_ADMINSCRIPT;?>?m=setting&a=mail" method="post">
				...
				<table class="opt">
					...
					<tr>
						<td>
							<label><input type="radio" class="radio" name="mailauth"<?php if($mailauth == 1) { ?> checked="checked"<?php } ?> value="1" />ใช่</label>
							<label><input type="radio" class="radio" name="mailauth"<?php if($mailauth == 0) { ?> checked="checked"<?php } ?> value="0" />ไม่</label>
						</td>
					...
					<tr>
						<td>
							<label><input type="radio" class="radio" name="mailusername"<?php if($mailusername == 1) { ?> checked="checked"<?php } ?> value="1" />ใช่</label>
							<label><input type="radio" class="radio" name="mailusername"<?php if($mailusername == 0) { ?> checked="checked"<?php } ?> value="0" />ไม่</label>
						</td>
					...
					<tr>
						<td>
							<label><input type="radio" class="radio" name="mailsilent"<?php if($mailsilent == 1) { ?> checked="checked"<?php } ?> value="1" />ใช่</label>
							<label><input type="radio" class="radio" name="mailsilent"<?php if($mailsilent == 0) { ?> checked="checked"<?php } ?> value="0" />ไม่</label>
						</td>
						<td valign="top">&nbsp;</td>
					</tr>
				</table>
