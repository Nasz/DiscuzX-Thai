...
function loadcalendar() {
	...
	s += '<th><a href="###" onclick="refreshcalendar(yy, mm-1)" title="เดือนก่อน">《</a></th>';
	s += '<th colspan="5" style="text-align: center"><a href="###" onclick="showdiv(\'year\');_cancelBubble(event)" title="คลิกเพื่อเลือกปี" id="year"></a>&nbsp; - &nbsp;<a id="month" title="คลิกเพื่อเลือกเดือน" href="###" onclick="showdiv(\'month\');_cancelBubble(event)"></a></th>';
	s += '<th><A href="###" onclick="refreshcalendar(yy, mm+1)" title="เดือนหน้า">》</A></th>';
	s += '</tr>';
